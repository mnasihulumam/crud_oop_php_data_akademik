...
<html lang="en">
  ...
  <div class="container-fluid" style="padding-bottom: 450px;">
    <div class="alert alert-dark">
          ...
          <form method="post" action="proses_dosen.php?action=update">
             <div class="form-group">
              <label for="">Kode Dosen</label>
              <input type="text" name="nip" class="form-control" readonly value="<?php echo $data_dosen['nip']; ?>"/>
            </div>
            <div class="form-group">
              <label for="">Nama</label>
              <input type="text" name="nama" value="<?php echo $data_dosen['nama']; ?>" class="form-control">
            </div>
            <div class="form-group">
              <label for="">Jenis Kelamin</label>
              <label><input type="radio" name="jk" value="L" <?php if($data_dosen['jk']=='L') echo 'checked'  ?>>L</label>
              <label><input type="radio" name="jk" value="P" <?php if($data_dosen['jk']=='P') echo 'checked'  ?>>P</label>
            </div>
            <div class="form-group">
              <label for="">Agama</label>
              <input type="text" name="agama" value="<?php echo $data_dosen['agama']; ?>" class="form-control">
            </div>
            <div class="form-group">
              <label for="">Alamat</label>
              <textarea name="alamat" id="" cols="" rows="3" class="form-control"><?php echo $data_dosen['alamat']; ?></textarea>
            </div>
            <div class="form-group">
              <button type="submit" name="tombol" class="btn btn-primary">Update</button> <button class="btn btn-warning"><a href="tampil_dataDSN.php" style="text-decoration: none;">Kembali</a></button>
            </div>
          </form>
        </div>
        </div>
