...
include('config.php');
$db = new database();
$data_mahasiswa = $db->tampil_dataMHS();
?>
<!doctype html>
<html lang="en">
  <head>
        ...
        <div id="content">
          <div class="container-fluid" style="padding-bottom: 450px;">
            ...
            <hr class="bg-secondary"></hr>
              <a href="tambah_dataMHS.php" class="btn-warning pr-3 pl-3" style="border-radius: 5px;">Tambah Data</a>
                  <table class="table">
                    <thead>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="proses_mahasiswa.php?action=delete&id=<?php echo $row['nim']; ?>" class="badge badge-danger">Delete</a>
                          <a href="edit_mahasiswa.php?id=<?php echo $row['nim']; ?>" class="badge badge-success">Edit</a>
                        </td>
                      </tr>
